...
<hmtl lang="fr">
    ...
    <head>
        <title>LaPlateform.com.com</title>
        <meta charset="utf-8" />
...
?>
        ...
        <h4>Modifie tes informations ici <input type="submit" name="modifier" value="Modifier"></h4>
        ...
        <div class="ajout-com">  
            <h4>
                Tu peux aussi Ajouter un mot au livre D'or !
            </h4>
        </div>
        </a>
        </section>
